...
I created this learning path using [roadmap.sh](https://roadmap.sh/) and took some suggestions from Google/Reddit. Using [Excalidraw](https://excalidraw.com/), it made the path look more viable to me and achievable.
...
* [Pomofocus.io](https://pomofocus.io/) - Pomodoro timer to help me focus, take breaks, and prevent burnout.
    * <i>I'm currently doing 35 minutes of work time / 6 minute short breaks / 20 minute long breaks</i>
...
### ReactJS
* [ReactJS for Beginners with freeCodeCamp](https://www.youtube.com/watch?v=bMknfKXIFA8) - <i>YouTube</i>
#### Projects
* <i>Future Project Here</i>
